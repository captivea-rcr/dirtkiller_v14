...
class DynamicCheque(models.Model):
	...
	company_image_medium = fields.Binary("Company Logo")
	cn_company_name = fields.Char('Company Name')
	cn_street = fields.Char('Street')
	cn_street2 = fields.Char('Street2')
	cn_phone = fields.Char('Phone')
	cn_fax = fields.Char('Fax')
	micr_font = fields.Char('MICR Font')
	sign_image_medium = fields.Binary("Signature Logo")
...
class AccountPayment(models.Model):
	...
	next_check_number = fields.Integer('Next Check Number')
